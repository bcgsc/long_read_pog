...
We sequenced `r nrow(long_pog_cohort)` tumours, of which `r nrow(long_pog_cohort %>% select(-epigenomic_homd) %>% dplyr::filter(has_normal=='Y'))` had matching normal tissue also sequenced on the Nanopore. 
