...
phasing <- read.csv('/projects/epleasance/POG/manuscripts/LongPOG/figure_code/phasing_figure/phasing-stats.csv')
census <- read.csv('/projects/epleasance/POG/manuscripts/LongPOG/figure_code/phasing_figure/cosmic-gene-census.csv')
tumours <- read.csv('/projects/epleasance/POG/manuscripts/LongPOG/figure_code/phasing_figure/ensembl100-genes+promoters-blocks-summary-tumours.csv')
...
```{r phasing-tissue, warning=FALSE}
...
ggarrange(a1, b2, b, nrow = 1, labels = c('a', '', 'b'), font.label = list(size = 10))
dev.off()
```