...
biopsy_data <- fread('https://www.bcgsc.ca/downloads/nanopore_pog/supplementary_tables/Supplementary_Table_1_samples.tsv')


# Clean up the terms
biopsy_data <- biopsy_data %>% dplyr::select(anonymous_sample_ID_tumour, tumour_type_cohort, biopsy_site_cohort) %>%
  rename(sample = anonymous_sample_ID_tumour, tumour_type = tumour_type_cohort, biopsy_group = biopsy_site_cohort)
