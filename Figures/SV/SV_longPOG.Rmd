...
mavis_data <- fread('https://www.bcgsc.ca/downloads/nanopore_pog/SVs/combined2.tab.gz',encoding="UTF-8")
...
in_file_processed_tumour_comparison_insertion <- pre_process_mavis_by_library_insertion(fread('https://www.bcgsc.ca/downloads/nanopore_pog/SVs/combined2_ins.tab.gz', encoding="UTF-8") %>% filter(event_type == 'insertion'), FALSE)
...
oncoKB <- fread('/projects/epleasance/dbs/oncokb/cancerGeneList_210714.tsv', encoding="UTF-8")
```
