---
title: "Generate of karyogram"
author: "Glenn Chang"
output: html_document
---
## ASE karyogram 

This R Markdown is used to generate the karyogram figure for sample 25134. The figure uses ASE results from IMPALA, allelic methylation data from NanoMethPhase and copy number variant data from Ploidetect. The following Rmd is copied/modified from the `karyogramFigure.R` script in the IMPALA pipeline.
...
# Import data
cna <- read.delim("ref/25134_cna_condensed.txt", header = T)
dmr <- read.delim("ref/25134_callDMR.txt.gz", header = T)
ase <- readRDS("/projects/glchang_prj/finalPOGdata/allASEdata_anonymize.RDS") %>%
